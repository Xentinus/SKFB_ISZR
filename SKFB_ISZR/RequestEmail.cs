...
namespace SKFB_ISZR
{
    public partial class RequestEmail : Form
    {
        // Lépésszámláló
        ...
        // Felület betöltése
        private void RequestEmail_Load(object sender, EventArgs e)
        {
            GC.Collect();
            stepCounter = 0;
        }
        ...
        private void SetupStepGroup()
        {
            switch (stepCounter)
            {
                ...
                case 1: // Összesítés az igénylésről
                    DataSummary();
        ...
        {
            // Fájl mentés neve
            savePDF.FileName = $"{LoadingSplashScreen.dayToday} - {lastNameText.Text} {firstNameText.Text} e-mail cím igénylése";
            ...
            // Eredeti fájl helye
            string originalFilePath = $"{LoadingSplashScreen.userProfilePath}RequestEmail.docx";
            ...
            try
            {
                ...
                DocumentEditor.Create(originalFilePath, LoadingSave.savedFileLocation, "Email");
