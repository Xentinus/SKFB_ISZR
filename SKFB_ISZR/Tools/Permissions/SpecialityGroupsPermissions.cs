    ...
    internal class SpecialityGroupsPermissions
    {
        ...
        private static string GetBiztPermissions(string groupName)
        {
            switch (groupName)
            {
                ...
                case "Műveleti csoport":
                    {
                        return "SKFB-Bizt-MuveletiCsoport; SKFB-FN-fogugykez; SKFB-FN-karbejelento; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-eloallitasnaplo; SKFB-FN-Navigator-jelentesrekotnaplo";
                    }
                case "Fegyvermester":
                    {
        ...
        private static string GetBVPermissions(string groupName)
        {
            switch (groupName)
            {
                ...
                case "Körlet főfelügyelők":
                    {
                        return "SKFB-Bv-Kffe; SKFB-Bv-Kffe-KBK; SKFB-FN-Navigator-bitnaplo-korletfofelugyelo; SKFB-FN-korl-fofelugy; SKFB-FN-Fegyelmi-fofelugyelo; SKFB-Bv-Kffe-Iszak; SKFB-Bv-Kffe-IIszak; SKFB-Bv-Kffe-IIIszak; SKFB-Bv-Kffe-IVszak; SKFB-Ellenorzesinaplo-biztpub-olvasas; SKFB-FN-JFK-FEGYJUTMEGTEKINTO; SKFB-FN-karbejelento; SKFB-FN-korl-fofelugy; SKFB-FN-Navigator-bitnaplo; SKFB-FN-Navigator-bitnaplo-korletfofelugyelo; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-kffenaplo; SKFB-FN-Navigator-megtekinto; SKFB-Letszamjelentes-biztpub; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NX-ISZM; SKFB-VezetoiSzignalas";
                    }
                case "Bűnügyi nyilvántartók":
                    {
                        return "SKFB-Bv-Nyilvantarto; SKFB-FN-bunnyilv; SKFB-Abevjava; SKFB-Bfb; SKFB-eSzigno; SKFB-FN-bunnyilv; SKFB-FN-bunnyilv-ov; SKFB-FN-Fegyelmi-jogkor-gyakorloja; SKFB-FN-fogugykez; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-kart-megtekinto; SKFB-FN-kart-ugyintezo; SKFB-FN-PME-nyilvantartas; SKFB-FN-PME-nyilvantartas-megt; SKFB-FN-PME-ugyintezo; SKFB-FTPUsers; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-SzabStat; SKFB-Tavtargyalas adatszolgaltato";
                    }
                case "Nyilvántartási osztályvezető-helyettes":
                    {
                        return "SKFB-Bv-Nyilvantartovez; SKFB-FN-bunnyilv-ov; SKFB-Abevjava; SKFB-Bfb; SKFB-Bv-Bvov; SKFB-Bv-Nyilvantarto; SKFB-Bv-Nyilvantartovez; SKFB-Ellenorzesinaplo-biztpub-iras; SKFB-eSzigno; SKFB-FN-bunnyilv; SKFB-FN-bunnyilv-ov; SKFB-FN-fogl-bfb-ugyintezo; SKFB-FN-fogl-kult-reint-tiszt; SKFB-FN-fogl-munkaerogazdalkodo; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogugykez; SKFB-FN-fogugykez-ov; SKFB-FN-int-vedett; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-kart-megtekinto; SKFB-FN-kart-ugyintezo; SKFB-FN-Navigator-belepesinaplo; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-eloallitasnaplo; SKFB-FN-Navigator-jelentesrekotnaplo; SKFB-FN-Navigator-korletfelugyeloiellenorzesinaplo; SKFB-FN-Navigator-korletfelugyeloiellenorzesinaplo-jovahagyo; SKFB-FN-Navigator-megtekinto; SKFB-FN-PME-nyilvantartas; SKFB-FN-PME-nyilvantartas-megt; SKFB-FN-PME-ugyintezo; SKFB-FTPUsers; SKFB-IKKB; SKFB-IrfanView; SKFB-KiemeltFogvatartottR; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NX-ISZM; SKFB-OptenOptijusPlussz; SKFB-SzabStat; SKFB-Tavtargyalas adatszolgaltato; SKFB-Ter; SKFB-VezetoiSzignalas; SKFB-Vezetok";
                    }
                case "Körlet ellátó főfelügyelő (Anyagi)":
                    {
                        return "SKFB-Bv-Anyagi; SKFB-FN-befog-elsolet; SKFB-FN-csomagkezelo-atado; SKFB-FN-csomagkezelo-atado-szerk; SKFB-FN-csomagoszto; SKFB-FN-Fegyelmi-fofelugyelo; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogugykez; SKFB-FN-karbejelento; SKFB-FN-korl-fofelugy; SKFB-FN-Navigator-munkahelyiszolgalatinaplo; SKFB-FN-PME-ugyintezo; SKFB-FN-targyraktaros; SKFB-ForrasDotNet; SKFB-ForrasUsers; SKFB-NexonHRpersONLINE";
                    }
                ...
                case "Reintegraciós tisztek":
                    {
                        return "SKFB-Bv-Reintegracio; SKFB-FN-nevelok; SKFB-Bfb; SKFB-FlashEnabled; SKFB-FN-bunnyilv; SKFB-FN-bvbank-megtekinto; SKFB-FN-csomagkezelo-atado; SKFB-FN-csomagoszto; SKFB-FN-Fegyelmi-jogkor-gyakorloja; SKFB-FN-hivasnaplo-megtekinto; SKFB-FN-JFK-FEGYJUTMEGTEKINTO; SKFB-FN-karbejelento; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-Navigator-megtekinto; SKFB-FN-PME-reintegracio; SKFB-FN-PME-ugyintezo; SKFB-FN-TELEFON-ugyintezo; SKFB-FTPUsers; SKFB-HER-Behallgatok; SKFB-NexonHRpersONLINE";
                    }
                case "Vezető Reintegrációs tiszt":
                    {
                        return "SKFB-Bfb; SKFB-Bv-Reintegracio; SKFB-FlashEnabled; SKFB-FN-bunnyilv; SKFB-FN-bvbank-megtekinto; SKFB-FN-csomagkezelo-atado; SKFB-FN-csomagoszto; SKFB-FN-Fegyelmi-reintegracios-tiszt; SKFB-FN-fogugykez; SKFB-FN-hivasnaplo-megtekinto; SKFB-FN-JFK-FEGYJUTMEGTEKINTO; SKFB-FN-karbejelento; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-megtekinto; SKFB-FN-nevelok; SKFB-FN-PME-reintegracio; SKFB-FN-PME-ugyintezo; SKFB-FN-TELEFON-ugyintezo; SKFB-FTPUsers; SKFB-HER-Behallgatok; SKFB-NexonHRpersONLINE; SKFB-Ter";
                    }
                case "Szociális előadók":
                    {
                        return "SKFB-Bv-Szoceloado; SKFB-FN-admin; SKFB-FN-bunnyilv; SKFB-FN-bvbank-megtekinto; SKFB-FN-fogl-bfb-ugyintezo; SKFB-FN-fogugykez; SKFB-FN-karbejelento; SKFB-FN-korl-felugy; SKFB-FN-Navigator-bitnaplo-korletfofelugyelo; SKFB-FN-nevelok; SKFB-FN-PME-ugyintezo; SKFB-Letszamjelentes-biztpub; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NX-ISZM; SKFB-NX-SZAB";
                    }
        ...
        private static string GetEFOPPermissions(string groupName)
        {
            switch (groupName)
            {
                case "Csoportvezető":
                    {
                        return "SKFB-Bfb; SKFB-BIT-JELENTES; SKFB-BV; SKFB-Bv-Bvov; SKFB-Bv-Reintegracio; SKFB-Ellenorzesinaplo-biztpub-iras; SKFB-eSzigno; SKFB-FlashEnabled; SKFB-FN-bunnyilv; SKFB-FN-bvbank-megtekinto; SKFB-FN-csomagkezelo-atado; SKFB-FN-csomagkezelo-atado-szerk; SKFB-FN-csomagoszto; SKFB-FN-Fegyelmi-jogkor-gyakorloja; SKFB-FN-Fegyelmi-reintegracios-tiszt; SKFB-FN-fogl-kult-reint-tiszt; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogugykez-ov; SKFB-FN-hivasnaplo-megtekinto; SKFB-FN-int-vedett; SKFB-FN-JFK-FEGYJUTMEGTEKINTO; SKFB-FN-karbejelento; SKFB-FN-kart-adatszolgaltato; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-kart-megtekinto; SKFB-FN-kart-ugyintezo; SKFB-FN-korl-fofelugy; SKFB-FN-Navigator-belepesinaplo; SKFB-FN-Navigator-bitnaplo; SKFB-FN-Navigator-bitnaplo-jovahagyo; SKFB-FN-Navigator-bitnaplo-korletfofelugyelo; SKFB-FN-Navigator-bitnaplo-osztalyvezeto; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-ellenorzesinaplo-jovahagyo; SKFB-FN-Navigator-eloallitasnaplo; SKFB-FN-Navigator-jelentesrekotnaplo; SKFB-FN-Navigator-kffenaplo-jovahagyo; SKFB-FN-Navigator-megtekinto; SKFB-FN-Navigator-munkahelyiszolgalatinaplo; SKFB-FN-Navigator-munkahelyiszolgalatinaplo-jovahagyo; SKFB-FN-PME-bizottsag; SKFB-FN-PME-reintegracio; SKFB-FN-PME-ugyintezo; SKFB-FN-RIN-EFOPESETMENEDZSER; SKFB-FN-SZERZODES-MEGTEKINTO; SKFB-FN-TELEFON-megtekinto; SKFB-FTPUsers; SKFB-FTPVedelem; SKFB-HER-Behallgatok; SKFB-IKKB; SKFB-IrfanView; SKFB-KiemeltFogvatartottR; SKFB-Kozossegi-oldalak-infopub-olvas; SKFB-Letszamjelentes-biztpub; SKFB-MarathonTerra3; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NoemiHelpDesk; SKFB-NX-ISZA; SKFB-NX-ISZM; SKFB-NX-SZAB; SKFB-NYDR; SKFB-NYDR-Reint; SKFB-OptenOptijus; SKFB-OptenOptijusPlussz; SKFB-Pictures; SKFB-Ter; SKFB-VezetoiSzignalas";
                    }
        ...
        private static string GetGazdosztPermissions(string groupName)
        {
            switch (groupName)
            {
                ...
                case "Gépház vezetők":
                    {
                        return "SKFB-ForrasUsers; SKFB-Gazd-Gephazvez; SKFB-IrfanView; SKFB-NX-ISZM; SKFB-Nexon; SKFB-FN-fogugykez; SKFB-FTPUsers; SKFB-NexonHRpersONLINE; SKFB-NoemiHelpDesk; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogl-munkaerogazdalkodo; SKFB-FN-PME-nyilvantartas-megt; SKFB-ForrasDotNet; SKFB-Letszamjelentes-biztpub; SKFB-Bizttechfejlesztes; SKFB-FN-Navigator-munkahelyiszolgalatinaplo";
                    }
                ...
                case "Élelmezési csoport":
                    {
                        return "SKFB-Elelmezes; SKFB-FN-ELELEM-elelmezv; SKFB-FN-ELELEM-konyhav; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogugykez; SKFB-FN-Navigator-munkahelyiszolgalatinaplo; SKFB-ForrasDotNet; SKFB-ForrasUsers; SKFB-Gazd-Elelmezes; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NoemiHelpDesk; SKFB-NX-ISZM";
                    }
                default:
                    {
                        return noPermissions;
        ...
        private static string GetGazdtarsPermissions(string groupName)
        {
            switch (groupName)
            {
                case "Biztonsági vezető":
                    {
                        return "SKFB-Adatszolgaltatasok; SKFB-BIT-JELENTES; SKFB-Ellenorzesinaplo-biztpub-iras; SKFB-FN-bizt; SKFB-FN-bizt-ov; SKFB-FN-bunnyilv; SKFB-FN-Fegyelmi-egyeb-szakterulet; SKFB-FN-Navigator-belepesinaplo; SKFB-FN-Navigator-ejfeli-adatszolgaltatas; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-eloallitasnaplo; SKFB-FN-Navigator-jelentesrekotnaplo; SKFB-FN-Navigator-megtekinto; SKFB-FN-nevelok; SKFB-FN-TELEFON-ugyintezo; SKFB-FTPUsers; SKFB-Gt-Biztvez; SKFB-KiemeltFogvatartottR; SKFB-MarathonTerra3; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NX-ISZM; SKFB-OptenOptijus; SKFB-Ter; SKFB-VezetoiSzignalas; SKFB-Vezetok; SKFB-Vir; SKFB-VIR-Munkaltatas-User";
                    }
                case "Munkaügyi csoport":
                    {
                        return "SKFB-Adatszolgaltatasok; SKFB-FN-fogl-bfb-ugyintezo; SKFB-FN-fogl-kult-reint-tiszt; SKFB-FN-fogl-munkaerogazdalkodo; SKFB-FN-fogl-munkahelyvezeto; SKFB-FN-fogl-param-szerk; ; SKFB-Gt-Munkaugy; SKFB-Kozfoglalkprog; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NoemiHelpDesk; SKFB-NX-ISZM; SKFB-NX-SZAB; SKFB-Vezetoi-elfoglaltsag";
                    }
                case "Titkárság":
                    {
        ...
        private static string GetVezkozvPermissions(string groupName)
        {
            switch (groupName)
            {
                ...
                case "Nyomozó és fegyelmi tiszt":
                    {
                        return "SKFB_NapijelentesekEnabled; SKFB-BIT-JELENTES; SKFB-Ellenorzesinaplo-biztpub-olvasas; SKFB-FN-JFK-FEGYJUTMEGTEKINTO; SKFB-FN-Navigator-bitnaplo; SKFB-FN-Navigator-bitnaplo-osztalyvezeto; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-jelentesrekotnaplo; SKFB-FTPUsers; SKFB-IKKB; SKFB-IrfanView; SKFB-Kommunikacios; SKFB-Napijelentes; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NX-IFEM; SKFB-OptenOptijus; SKFB-Pictures; SKFB-SajtoRZS; SKFB-Szenyor; SKFB-Vezetok; SKFB-Vezkozv-Eloado; SKFB-Vezkozv-Fegyelmi";
                    }
                case "Jogtanácsosok":
                    {
                ...
                case "Kártalantási előadók":
                    {
                        return "SKFB-Abevjava; SKFB-FN-bunnyilv; SKFB-FN-fogugykez; SKFB-FN-kart-adatszolgaltato; SKFB-FN-kart-egyeb-panasz-kivizsgalo; SKFB-FN-kart-megtekinto; SKFB-FN-kart-ugyintezo; SKFB-FN-nevelok; SKFB-Vezkozv-Kartalanitas";
                    }
                case "Lelkészek":
                    {
                ...
                case "Munkavédelmi vezető":
                    {
                        return "SKFB-Adatszolgaltatasok; SKFB-Ellenorzesinaplo-biztpub-iras; SKFB-Ellenorzesinaplo-biztpub-olvasas; SKFB-FN-Fegyelmi-reintegracios-tiszt; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-Navigator-jelentesrekotnaplo; SKFB-FN-Navigator-megtekinto; SKFB-FTPUsers; SKFB-IKKB; SKFB-NexonHRpersONLINE; SKFB-OptenOptijus; SKFB-VezetoiSzignalas; SKFB-Vezkozv-Munkavedelem";
                    }
                case "Pszichológusok":
                    {
                        return "SKFB-Animula; SKFB-Bfb; SKFB-Bortonadaptacio; SKFB-FN-bunnyilv; SKFB-FN-EU-AltPszichologiaFogv-Orvos; SKFB-FN-EU-Psychoterapi-Orvos; SKFB-FN-EU-PszichiatriaFogv-Orvos; SKFB-FN-EU-PszichologiaBefogadoFogv-Orvos; SKFB-FN-Fegyelmi-egyeb-szakterulet; SKFB-FN-Navigator-ellenorzesinaplo; SKFB-FN-nevelok; SKFB-FN-PME-egeszsegugy-megt; SKFB-FN-PME-nyilvantartas-megt; SKFB-FN-PME-pszichologia; SKFB-FN-PME-pszichologia-megt; SKFB-FN-PME-reintegracio-megt; SKFB-FN-PME-ugyintezo; SKFB-IrfanView; SKFB-Nexon; SKFB-NexonHRpersONLINE; SKFB-NoemiHelpDesk; SKFB-NX-ISZM; SKFB-NX-SZAB; SKFB-PszichoProgramok; SKFB-Scpi; SKFB-Temperamentum; SKFB-VezetoiSzignalas; SKFB-Vezkozv-Pszichologus";
                    }
